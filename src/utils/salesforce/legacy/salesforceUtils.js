...
class SalesforceUtils {
  ...
  constructor(config) {
    ...
    // Initialize auth utils for token generation
    this.authUtils = new SalesforceAuthUtils(config);
  }
  ...
  async generateAccessToken() {
    return await this.authUtils.generateAccessToken();
  }
   ...
   */
  async validateToken() {
    return await this.authUtils.validateToken();
  }
   ...
   */
  async refreshToken() {
    return await this.authUtils.refreshToken();
  }
   ...
   */
  getTokenInfo() {
    return this.authUtils.getTokenInfo();
  }
}
