...
const { DataProtection } = require('../../security');
...
function log(level, message, data) {
  ...
  // Mask sensitive data
  const maskedMessage = DataProtection.maskSensitiveData ? DataProtection.maskSensitiveData(formattedMessage) : formattedMessage;
